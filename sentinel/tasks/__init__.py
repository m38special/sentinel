...
app.conf.update(
    ...
    beat_schedule={
        ...
        # Daily Briefing (Yoruichi + NOVA) at 7am CT
        "daily-briefing-7am-ct": {
            "task": "tasks.cfo_command.generate_daily_briefing",
...
# Manually include task modules to ensure they're registered
# This is a backup to autodiscover in case of timing issues
from tasks import (
    alert_router,
    cfo_command,
    content_approval,
